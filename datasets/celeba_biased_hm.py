...
from datasets.celeba_biased import CelebADataset
...
def get_celeba_biased_hm_dataset(data_paths, normalize_data=True, image_size=224, artifact_ids_file=None, artifact=None,
                                 **kwargs):
    fns_transform = [
    ...
    return CelebABiasedHmDataset(data_paths, train=True, transform=transform, augmentation=celeba_augmentation,
                                 artifact_ids_file=artifact_ids_file, artifact=artifact)


class CelebABiasedHmDataset(CelebADataset):
    def __init__(self, data_paths, train=True, transform=None, augmentation=None, artifact=None,
        ...
        self.hm_path = f"data/localized_artifacts/celeba_biased"
